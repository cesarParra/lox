...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        for (Stmt.Function method : stmt.methods) {
            // Create a new function and store it in the current environment.
    ...
    void executeBlock(List<Stmt> statements, Environment environment) {
        // Temporarily save the previous environment, since we want to restore it after executing the block.
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        ...
        // At the same time, store the function in the environment as a variable with the same name.
